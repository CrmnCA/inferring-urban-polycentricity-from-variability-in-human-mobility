...
def figure_monocentric_hypothesis(df_distribution_network, predictions, direc, city):
    ...
    fig.savefig(direc +  'Plots/' + str(city) + '_test_monocentric.jpg', bbox_inches = 'tight')


# In[14]:


def monocentric_hypothesis(df_distribution_network, i, direc, city):
    ...
    if i == 0:
        ...
        figure_monocentric_hypothesis(df_distribution_network, predictions, direc, city)
...
def figure_model_2mix(df_distribution_network, predictions_proximal_2mix, predictions_distal_2mix, direc, city):
    ...
    fig.savefig(direc +  '/Plots/' + str(city) + '_2_mixture_mean_vs_distance_to_nucleus.pdf', bbox_inches = 'tight')
...
def model_2mix(df_distribution_network, i, direc, city):  
    ...
    if i == 0:
        ...
        figure_model_2mix(df_distribution_network, predictions_proximal_2mix, predictions_distal_2mix, direc, city)
...
def figure_model_3mix(df_distribution_network, predictions_proximal_3mix, predictions_medial_3mix, predictions_distal_3mix, direc, city):
    ...
    fig.savefig(direc +  '/Plots/' + str(city) + '_3_mixture_mean_vs_distance_to_nucleus.pdf', bbox_inches = 'tight')
...
def model_3mix(df_distribution_network, i, direc, city):  
    ...
    if i == 0:
        ...
        figure_model_3mix(df_distribution_network, predictions_proximal_3mix, predictions_medial_3mix, predictions_distal_3mix, direc, city)
